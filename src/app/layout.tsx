...
export const metadata: Metadata = {
  title: "PLANIN — Smart Time Planner",
  description:
    "Personal smart time planner: work, Cybersecurity formation, study, sport and French — automatically scheduled.",
  applicationName: "PLANIN",
